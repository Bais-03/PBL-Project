...
export default function ResetPassword() {
  ...
  const { token } = useParams(); // This captures the token from URL
    ...
    return (
      <div className="auth-container">
        ...
        >
          ...
          <Link to="/forgot-password" className="login-btn" style={{ textAlign: "center", textDecoration: "none" }}>
            Request New Link
          </Link>
      ...
      <div className="auth-container">
        ...
        >
          <div style={{ textAlign: "center", padding: "2rem" }}>
            <div className="login-btn loading" style={{ width: "40px", margin: "0 auto" }} />
